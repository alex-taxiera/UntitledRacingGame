...
#include "VehicleExamplePlayerController.generated.h"

class UInputMappingContext;
class AVehicleExamplePawn;
class UVehicleExampleUI;
...
class AVehicleExamplePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AVehicleExamplePawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AVehicleExamplePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UVehicleExampleUI> VehicleUIClass;

	/** Pointer to the UI widget */
	UPROPERTY()
	TObjectPtr<UVehicleExampleUI> VehicleUI;
...
protected:
	...
	/** Pawn setup (server-side) */
	virtual void OnPossess(APawn* InPawn) override;

	/** Called on the owning client when possession is acknowledged — mirrors OnPossess for client state. */
