...
#include "VehicleExampleSportsCar.h"
#include "VehicleExampleSportsWheelFront.h"
#include "VehicleExampleSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AVehicleExampleSportsCar::AVehicleExampleSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleExampleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleExampleSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleExampleSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleExampleSportsWheelRear::StaticClass();
