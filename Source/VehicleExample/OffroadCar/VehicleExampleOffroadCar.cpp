...
#include "VehicleExampleOffroadCar.h"
#include "VehicleExampleOffroadWheelFront.h"
#include "VehicleExampleOffroadWheelRear.h"
...
AVehicleExampleOffroadCar::AVehicleExampleOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleExampleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleExampleOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleExampleOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleExampleOffroadWheelRear::StaticClass();
